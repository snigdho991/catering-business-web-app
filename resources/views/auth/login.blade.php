                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="text-muted text-center" style="margin-top: 30px !important;">Don't have a customer account ? <a href="{{ route('login') }}" class="fw-medium text-primary"> Sign Up</a> </p>
                                        </div>
                                    </div>
