                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" action="{{ route('store.service') }}" method="post" novalidate="">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" class="form-control" id="validationTooltip01" placeholder="Enter service name" name="name" value="{{ old('name') }}" required="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" class="form-control" id="validationTooltip03" placeholder="Enter service price" name="price" value="{{ old('price') }}" required="">
                                            <div class="valid-tooltip">
                                                Looks good!
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <textarea id="textarea" name="description" required="" class="form-control" rows="5" placeholder="Write down the description of the service">{!! old('description') !!}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-primary" style="margin-top: 6px !important; width: 100% !important" type="submit">Save New Service</button>
